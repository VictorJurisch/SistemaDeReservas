...
$consulta = mysqli_query($conexao, "SELECT * FROM usuariosrestaurante WHERE email = '$email' AND senha = '$senha'") or die("Erro na reserva");
...
if($total_linhas != 0){
    ...
    <?php echo "E-mail ou Senha incorretos"; ?>
    </div>
    <?php
}else{
